...
namespace MoviesAPI.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        [ProducesResponseType(typeof(MoviesAPi.DTOs.UserToken), 200)]
        [HttpPost("Create")]
        public async Task<ActionResult<MoviesAPi.DTOs.UserToken>> CreateUser([FromBody] UserInfo model)
        {
        ...
        [HttpPost("Login")]
        public async Task<ActionResult<MoviesAPi.DTOs.UserToken>> Login([FromBody] UserInfo model)
        {
        ...
        public async Task<ActionResult<MoviesAPi.DTOs.UserToken>> Renew()
        {
        ...
        private async Task<MoviesAPi.DTOs.UserToken> BuildToken(UserInfo userInfo)
        {
            ...
            return new MoviesAPi.DTOs.UserToken()
            {
